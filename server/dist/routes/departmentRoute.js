...
router.get('/groupgender', departmentControllers_1.departmentControllers.getAllAndGroupGenderPerson);
router.get('/groupworkingtype', departmentControllers_1.departmentControllers.getAllAndGroupWorkingTypePerson);
